...
**IMPORTANT:** This component is copied from https://github.com/open-telemetry/opentelemetry-collector-contrib/tree/v0.39.0/exporter/kafkaexporter and 
addapted to accept compression settings.
