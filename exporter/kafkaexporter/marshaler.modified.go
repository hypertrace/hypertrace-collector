...
// creates TracesMarshaler based on the provided config. If SpanCuring.Enbaled is true and we are using "jaeger_proto" message encoding, we will switch out the
